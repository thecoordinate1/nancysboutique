                ...
                <div className="border-t border-champagne/40 p-5 space-y-4 bg-pearl/20">
                  ...
                  <div className="space-y-2">
                    <button 
                      ...
                      className="w-full py-3.5 rounded-full bg-charcoal text-cream text-sm tracking-wider hover:bg-charcoal/90 transition-colors flex items-center justify-center gap-2"
                    >
                      <CreditCard size={16} />
